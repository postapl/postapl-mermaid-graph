...
it.skip('create component graph code in messages', async () => {
  // const data = {
  //   "key1": "",
  //   "key2": "value2"
  // }
  ...
  await run(data, data, {componentGraphPath: '##messages:foo'}, 'foo', graph.toString());
})

it('create component graph code as file', async () => {
  // const data = {
  //   "key1": "",
  //   "key2": "value2"
  // }
  await run(data, data, {componentGraphPath: './test/output/screen.componentGraph.txt'});
})
